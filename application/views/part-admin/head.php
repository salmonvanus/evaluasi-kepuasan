<head>
	<meta charset="utf-8" />
	<title><?= (isset($display)) ? $display . " &mdash; " : ""; ?>Evaluasi Kepuasan | Kejaksaan Negeri Tomohon</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta content="PT Cleverlabs Indonesia" name="description" />
	...
	<link href="<?= base_url(); ?>assets/plugins/filter/magnific-popup.css" rel="stylesheet" type="text/css" />
