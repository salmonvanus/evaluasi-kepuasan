            ...
            <article class="uk-article">
              ...
              <div class="uk-article-meta uk-margin uk-flex uk-flex-middle">
                ...
                <div>
                  ...
                  <time class="uk-margin-small-right"><?php $publish_date = $data['article_date_publish'];
                                                      echo date("d-m-Y", strtotime($publish_date)); ?></time><br>
                  Updated <time><?php $date_updated = $data['article_date_modified'];
                                echo date("d-m-Y", strtotime($date_updated)); ?></time>
                </div>
              </div>
