...
<body>
		...
		<nav class="navbar-custom">
			...
			<div class="topbar-left">
				<a href="Login" class="logo">
					<span>
						<img src="assets/images/logo_prov.png" alt="logo-small" class="logo-sm">
						<img src="assets/images/kesbang.png" alt="logo-large" class="logo-lg">
					</span>
					<span>
					</span>
				</a>
	...
	<div class="page-content">
		...
		<footer class="footer text-center text-sm-left">
			Powered by Cleverlabs Indonesia <span class="text-muted d-none d-sm-inline-block float-right"></span><img src="assets/images/logo_cleverlabs.png" alt="logo-small" style="width: 4%" class="logo-sm">
		</footer>
	</div>
	<!-- end page content -->
	</div>
