        ...
        function ubah_pertanyaan(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('[name=jenis_pertanyaan]').val(data.jenis_pertanyaan);
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="name">Pertanyaan Harapan/Pelayanan</label>
                        <input type="hidden" name="add_jenis_pertanyaan[]" value="Pertanyaan Harapan/Pelayanan">
                        <textarea name="add_pertanyaan[]" class="form-control" cols="30" rows="5" autocomplete="off" placeholder="Masukkan Jenis Pertanyaan Harapan/Pelayanan" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="name">Pertanyaan Persepsi/Layanan</label>
                        <input type="hidden" name="add_jenis_pertanyaan[]" value="Pertanyaan Persepsi/Layanan">
                        <textarea name="add_pertanyaan[]" class="form-control" cols="30" rows="5" autocomplete="off" placeholder="Masukkan Jenis Pertanyaan Persepsi/Layanan" required></textarea>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="jenis_pertanyaan" class="form-control" required disabled>
                    ...
                    <div class="form-group">
                        ...
                        <select name="ed_jenis_pertanyaan" class="form-control" hidden>
                            <option value="Pertanyaan Harapan/Pelayanan">Pertanyaan Harapan/Pelayanan</option>
                            <option value="Pertanyaan Persepsi/Layanan">Pertanyaan Persepsi/Layanan</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="name">Pertanyaan Harapan/Pelayanan</label>
                        <input type="hidden" name="ed_jenis_pertanyaan" value="Pertanyaan Harapan/Pelayanan">
                        <textarea name="ed_pertanyaan" class="form-control" cols="30" rows="5" autocomplete="off" required></textarea>
                    </div>

                </div>
                <div class="modal-footer">
                    <button class="btn btn-info waves-effect waves-light" type="submit"><span>Simpan</span> <i class="fas fa-edit ml-3"></i></button>
